# Contributing to appsentiment

We would love for you to contribute to appsentiment and help make it ever better together! :rocket:
...
Help us keep appsentiment open and inclusive. Please read and follow our [Code of Conduct][coc].

## <a name="question"></a> Got a Question or Problem?

Please do not open issues for general support questions as we want to keep GitHub issues for bug reports and feature requests. You've got much better chances of getting your question answered on [StackOverflow][stackoverflow] where the questions should be tagged with tag `appsentiment`.
...
* If you have a question about using appsentiment, please ask on the [StackOverflow][stackoverflow].
...
* In GitHub, send a pull request to `appsentiment:master`.
...
we use the git commit messages to **generate the appsentiment change log**.
...
[dev-doc]: DEV_DOCS.md
[github]: https://github.com/akveo/appsentiment
[stackoverflow]: https://stackoverflow.com/questions/tagged/appsentiment
[issues]: https://github.com/akveo/appsentiment/issues
[new_issue]: https://github.com/akveo/appsentiment/issues/new
[pulls]: https://github.com/akveo/appsentiment/pulls
